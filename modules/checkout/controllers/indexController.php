...
function indexAction()
{
    ...
    if (isset($_POST['btn_order'])) {
        ...
        if (empty($error)) {
            ...
            $subject = "[LOIPC] Xác nhận đặt hàng";
            ...
            <div class='top-info'>
                ...
                <span class='sub-title'>Cảm ơn Anh/Chị đã tin tưởng lựa chọn LOIPC</span>
            </div>
            <div class='content-info'>
                ...
                <ul>
                    ...
                    <li style='padding: 5px 0;'>
                        ...
                        <span>loichu1998@gmail.com hoặc sđt:0961680324</span>
                    </li>
                </ul>
            </div>
            <div class'footer-info'>
                <p>LOIPC hẹn gặp lại quý khách !</p>
            </div>
        </div>";
